...
parser.add_argument('--delta_z', type=float, default=-90,
...
def save_images(object_file: str, viewidx: int) -> None:
    ...
    if args.random_azi_ele:
        print("random_azi_ele")
        ...
        print("random_azimuth")
        delta_z = np.random.uniform(-60, 60, 1)  # left right rotate
        delta_x = 0  # up and down rotate
        delta_y = 0
    elif args.random_elevation:
        print("random_elevation")
        delta_z = args.delta_z  # left right rotate
        delta_x = np.random.uniform(-15, 30, 1)  # up and down rotate
        delta_y = 0
    else:
        print("fix poses")
