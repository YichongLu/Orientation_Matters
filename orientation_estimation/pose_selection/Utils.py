...
def depth2xyzmap(depth, K, uvs=None):
  ...
  # xyz_map = np.zeros((H,W,3), dtype=np.int16)
...
def compute_crop_window_tf_batch(pts=None, H=None, W=None, poses=None, K=None, crop_ratio=1.4, out_size=None, rgb=None, uvs=None, method='min_box', mesh_diameter=None):
